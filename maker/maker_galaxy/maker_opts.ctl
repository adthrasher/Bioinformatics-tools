...
genome:/home/athrash1/galaxy-dist/database/files/000/dataset_19.dat #genome sequence file in fasta format
...
est:/home/athrash1/galaxy-dist/database/files/000/dataset_21.dat #non-redundant set of assembled ESTs in fasta format (classic EST analysis)
...
repeat_protein:/home/athrash1/galaxy-dist/database/files/000/dataset_22.dat #a database of transposable element proteins in fasta format
...
predictor:augustus,est2genome,protein2genome #prediction methods for annotations (seperate multiple values by ',')
unmask:0 #Also run ab-initio methods on unmasked sequence, 1 = yes, 0 = no
snaphmm: #SNAP HMM model
gmhmm: #GeneMark HMM model
augustus_species:aedes #Augustus gene prediction model
